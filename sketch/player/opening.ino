...
static const unsigned char __burstWriteData_0[] PROGMEM = {
    0x00, 0x5d, 0xa3, 0x00, 0xbb, 0x46, 0x00, 0x5d,
    0xa3, 0x1a, 0x1b, 0x23, 0xf4, 0x6e, 0x4f};
static const unsigned char __burstWriteData_3[] PROGMEM = {
...
void opening() {
  ...
  // setup EQ
  progmemReadBuffer(sdBuffer, __burstWriteData_0, 15);
  ...
  progmemReadBuffer(sdBuffer, __burstWriteData_3, 35);
